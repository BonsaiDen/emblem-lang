...
s.defineIndexGetOp('int', 'string', '$1.charAt($2)');
s.defineIndexSetOp('int', 'string', 'string', '$1.charAt($2) = $3');
//s.defineRangeGetOp('int', 'int', Type.createList('string'), '$1.slice($2, $3)');
//s.defineRangeSetOp('int', 'int', Type.createList('string'), 'string', '$1.slice($2, $3)');
