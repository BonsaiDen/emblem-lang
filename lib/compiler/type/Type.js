...
// Create Other Default Types -------------------------------------------------
Type.emptyList = createType('list');
Type.emptyMap = createType('map');
//Type.emptyStruct = createType('struct');
