...
var Parser = function(source) {
    ...
    function parseLine() {
        ...
        // Type declarations
            ...
            stmt = parseDeclaration(true, true);
            expectNewline();
    ...
    // Declarations -----------------------------------------------------------
    // ------------------------------------------------------------------------
    function parseDeclaration(allowFunctions, allowValue) {
    ...
    function parseFunction(name, returnType) {
        ...
        while(true) {
            ...
            params.push(parseDeclaration(false, false));
            if (!match(',')) {
                break;
    ...
    function parseTypeDesc() {
        ...
        if (inType) {
            ...
            // TODO remove type desc? it's just a wrapper around type...
            type = parseType(true, modifier);
        ...
        if (match('(')) {
            ...
            return node.Type('function', [type, params]);
