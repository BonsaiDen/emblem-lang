...
var Parser = function(source) {
    ...
    function parseLine() {
        ...
        // Comments
        if (match('LINE_COMMENT')) {
            parseLineComment();

        } else if (match('DOC_COMMENT')) {
        ...
        // Type declarations
            ...
            stmt = parseVariable();
            if (match('LINE_COMMENT')) {
                parseLineComment(); // TODO insert into stream later
            }
            expectNewline();
    ...
    function parseLineComment() {
        return node.Comment(expect('LINE_COMMENT').value);
    }
    ...
    // Types ------------------------------------------------------------------
    function parseTypeDesc(inClass) {
    ...
    function binaryPrecedence(op) {
        switch(op) {
            ...
            // TODO in operator, type operator?
    ...
    function parseUnaryExpression() {
        ...
        // TODO check if in class function here
        } else if (match('@')) {
