...
Node('Variable', function(typeDesc, name, expression) {
    ...
    init: function() {
        this.scope.defineName(this.name.toString(), this.typeDesc);
    },
    ...
    toString: function() {
        ...
        var type = this.getType(),
            ...
            template = type.getAssignTemplate(exprType),
            value = this.expression || type.getDefaultValue();

        // TODO this won't work with complex overloads at the moment
