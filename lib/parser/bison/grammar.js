...
// TODO create a better DSL to describe the syntax...
// TODO create a custom parser to built the AST in the short/long term
var grammar = {
    ...
    // Match ------------------------------------------------------------------
    MatchStmt: [
        ['MATCH Expression { MatchCaseList }', 'new Match($2, $4)']
    ],

    MatchCaseList: [
        ['MatchCase',               '[$1]'],
        ['MatchCaseList MatchCase', '$1.push.apply($1, $2)']
    ],

    MatchCase: [
        ['CASE Expression Block', 'new MatchCase($2, $3)']
    ],


    // Loop -------------------------------------------------------------------
    LoopStmt: [
        ['LOOP Block',            'new Loop(null, $2)'],
        ['LOOP Expression Block', 'new Loop($2, $3)']
    ],
    ...
    EachStmt: [
        [
            'EACH TypeDesc Identifier IN Expression Block',
            'new Each($2, $3, null, null, $4, $5)'
        ],
        [
            'EACH TypeDesc Identifier , TypeDesc Identifier IN Expression Block',
            'new Each($2, $3, $5, $6, $8, $9)'
        ]
    ],
    ...
    Operation: [
        ...
        // a += b a *=b a /= b
        ['Assignable COMPOUND Expression', 'new Assign($1, $3, $2.substr(0, 1))']
    ],
