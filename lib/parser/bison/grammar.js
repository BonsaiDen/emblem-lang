...
var grammar = {
    ...
    Body: [
        ['Line NEWLINE',      'new Body($1)'],
        ['Body Line NEWLINE', '$1.addLine($2); $$ = $1'],
        'Body NEWLINE',
        ['NEWLINE',           'new Body(null)']
    ],
    ...
    Operation: [
        ...
        ['TypeCast Expression',            "new Cast($2)", { prec: 'UNARY'}],
    ...
    //StructType: [
        //'TYPE_STRUCT { StructBody }',
        //'TYPE_STRUCT [ Identifier ] { StructBody }',
    ...
    //StructLine: [
        //'TypeDesc Identifier = Expression',
        //'TypeDesc Identifier',
        //'NEWLINE'
    //],
